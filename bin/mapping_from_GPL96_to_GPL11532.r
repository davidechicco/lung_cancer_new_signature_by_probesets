...
mapping_table <- read.csv(file = "../data/probeset_mapping_files/Mark_files_results/GPL96_vs_GPL11532_results.csv", header=T)

ourPlatformIDs <- mapping_table[,c("Probe_ID_at_GPL96")]
otherPlatformIDs <- mapping_table[,c("Probe_ID_at_GPL11532")]
