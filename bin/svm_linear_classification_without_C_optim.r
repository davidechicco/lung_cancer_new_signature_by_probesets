...
# GPL96
#
# fileName <-  "../data/datasets_GPL96/Heiskanen_GSE68465_GPL96_patients_data_filtered_ourSignature_transpose_34_READY.csv"
# fileName <- "../data/datasets_GPL96/Wachi_GSE3268_GPL96_patients_data_filtered_ourSignature_transpose_2861_READY.csv"
# fileName <- "../data/datasets_GPL96/Want_GSE19027_GPL96_patients_data_filtered_ourSignature_transpose_6266_READY.csv"

#
# GPL570
#
# fileName <-  "../data/datasets_GPL570/Kohno_GSE31210_GPL570_patients_data_filtered_ourSignature_transpose_3757_READY.csv"
# fileName <-  "../data/datasets_GPL570/Kuner_GSE27489_GPL570_patients_data_filtered_ourSignature_transpose_7017_READY.csv"
# fileName <-  "../data/datasets_GPL570/Kuo_GSE103888_GPL570_patients_data_filtered_ourSignature_transpose_4646_READY.csv"
# fileName <-  "../data/datasets_GPL570/Mitchell_GSE101929_GPL570_patients_data_filtered_ourSignature_transpose_3241_READY.csv"
# fileName <-  "../data/datasets_GPL570/Philipsen_GSE19188_GPL570_patients_data_filtered_ourSignature_transpose_3935_READY.csv"
# fileName <-  "../data/datasets_GPL570/Rousseaux_GSE30219_GPL570_patients_data_filtered_ourSignature_transpose_9016_READY.csv"
# fileName <-  "../data/datasets_GPL570/Tsay_GSE54495_GPL570_patients_data_filtered_ourSignature_transpose_7271_READY.csv"
# fileName <-  "../data/datasets_GPL570/Xu_GSE118370_GPL570_patients_data_filtered_ourSignature_transpose_6479_READY.csv"
# fileName <-  "../data/datasets_GPL570/ZhangL_GSE32175_GPL570_patients_data_filtered_ourSignature_transpose_7670_READY.csv"

#
# GPL571
#
fileName <-  "../data/datasets_GPL571/Rotunno_GSE20189_GPL571_patients_data_filtered_ourSignature_transpose_5614_READY.csv"
...
cat("\n\n")
datasetName <- strsplit(strsplit(fileName, "/")[[1]][4], "_")[[1]][1]
cat(datasetName, " dataset ", sep="")
cat("ROSE: ", TRAIN_SET_OVERSAMPLING_SYNTHETIC, "\n", sep="")
