...
#     print(sort(names(platform_ann_df)))
    ...
    # ourSignatureSymbols <- c("ADH1A",     "ANK3",      "ARF6",      "BICD2",      "FAM106A",      "FARP2",      "FKBP1A",      "HLA-DQA1",      "N4BP2L1",      "NPAS2",      "P2RX4",     "PCSK5",      "RBP1",      "RPL10L",      "SLC16A4",      "SLC39A14",      "SOX15",      "SPATA20",      "TMEM45A",      "TRIM3",      "TSFM",      "WARS2")
