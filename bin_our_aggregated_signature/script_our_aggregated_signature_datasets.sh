...
outputFolder="../results_our_aggregated_signatures/"
mkdir -p $outputFolder
outputFile=$outputFolder"/our_aggregated_signature_rand"$random_number".txt"
...
Rscript preparation_and_classification_Rousseaux_data_probesets.r >> $outputFile 2>&1;
